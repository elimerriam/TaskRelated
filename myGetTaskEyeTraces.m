% myGetTaskEyeTraces.m
% slightly modified version of getTaskEyeTraces.m
%
%        $Id:$ 
...
sprintf('\n');
edf = myMglEyelinkEDFRead(eyeTrackerFilename,0);
...
%save original complete timecourses (to be used for microsaccade analysis)
